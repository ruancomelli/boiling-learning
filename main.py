...
Original file is located at
    https://colab.research.google.com/drive/199AaaZ9jICmaCej6TTBXoTFGwHDVDDao
...
# %load_ext autoreload
# %autoreload 2
# take a look at <https://stackoverflow.com/a/10472712/5811400> for why this is necessary
# it allows us to avoid restarting the kernel after installing new modules

# TODO: na condensação, fazer crop determinístico!!!
# TODO: depois, se tiver tempo, fazer RandomCrop pra comparar
# TODO: ver o quanto influencia crop determinístico versus
# TODO: para ambos os tipos de corte, rodar auto ML
# TODO: para um mesmo fluxo, mostrar imagens para os quatro
...
# if IS_COLAB_BACKEND and LOG_USER_IN:
#     gcloud_token = !gcloud auth print-access-token
#     gcloud_token = gcloud_token[0]
#     gcloud_tokeninfo = requests.get(f'https://www.googleapis.com/oauth2/v3/tokeninfo?access_token={gcloud_token}').json()
#     nb_user = gcloud_tokeninfo['email']

# # nb_user = 'ruan.comelli@lepten.ufsc.br'
...
strategy = LazyDescribed.from_value_and_description(strategy, strategy_name)
