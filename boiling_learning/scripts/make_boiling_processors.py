...
def main(
    ...
    return [
        ...
        Grayscaler(),
        {
            ...
            'GOPR2873': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2874': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2875': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2876': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2877': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2878': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2879': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2880': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2881': Cropper(left=990, right=1780, top=350, bottom=1250),
            'GOPR2882': Cropper(left=990, right=1780, top=350, bottom=1250),
